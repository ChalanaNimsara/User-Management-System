...
if(!isset($_SESSION['user_id'])){
    ...
    if(isset($_GET['user_id'])){
        ...
        if($result_set){
            ...
            // query unsuccessful
            header('Location: users.php?err=query_failded');
        }
    }
    ...
    if(isset($_POST['submit'])){
        ...
        if (empty($errors)){
            ...
            if($result){
                ...
                $errors[] = 'Failed to modify records.';
            }
        }
        ...
        <form action="modify-user.php" method="post" class="userform">
            <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                ...
                <p>
                    ...
                    <span>*******</span> | <a href="change-password.php?user_id=<?php
                    echo $user_id; ?>">Change Password</a>
                </p>
                <p>
                    <label for="">&nbsp;</label>
